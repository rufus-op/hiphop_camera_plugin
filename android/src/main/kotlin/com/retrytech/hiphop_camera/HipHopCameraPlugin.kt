package com.retrytech.hiphop_camera
...
/** FlutterDailogPlugin */
class HipHopCameraPlugin() : FlutterPlugin, MethodCallHandler, ActivityAware {
    ...
    override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
        channel = MethodChannel(flutterPluginBinding.binaryMessenger, "hiphop_camera")
